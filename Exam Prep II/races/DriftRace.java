...
public class DriftRace extends Race{
    ...
    public String toString() {
        ...
        super.getParticipants().stream().sorted((c1, c2) -> Integer.compare(c2.getSuspensionPerformance(), c1.getSuspensionPerformance()))
                .limit(3)
                .forEach(cars::add);
        ...
        for (Car car : cars) {
            sb.append(count).append(". ").append(car.getBrand()).append(" ").append(car.getModel()).append(" ")
                    .append(car.getSuspensionPerformance()).append("PP - $");
